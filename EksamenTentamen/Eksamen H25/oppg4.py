"""
LF Til Eksamen H25, oppgave 4. 
MERK: Detter er et kjent problem - Kaprekars tall/algoritme.
Den er så kjent at den ligger i Aunivers boka vår:
https://innhold.aunivers.no/fagpakker/realfag/informasjonsteknologi-1-2/it-2/utforskende-oppgaver/kaprekars-algoritme
"""
...
# Eventuelt slik:
# tall = int(input("Skriv inn et 4-sifret tall"))
tallspill(3142)
